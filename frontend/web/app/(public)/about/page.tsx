  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-12">
      <div className="text-center space-y-4 max-w-3xl mx-auto">
        <h1 className="text-balance text-3xl sm:text-4xl font-extrabold text-slate-950">The North Eastern Region challenge</h1>
        <p className="text-pretty text-slate-600 text-base leading-relaxed">
      ...
      <div className="surface-card p-6 sm:p-8 space-y-6">
        <h2 className="text-balance text-2xl font-bold text-slate-950 flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-sm">
          <div className="bg-slate-50 p-5 rounded-lg border border-slate-100 space-y-2">
            <h3 className="font-bold text-slate-900 text-base">Software-Only Core</h3>
            <p className="text-pretty text-slate-600">Zero reliance on expensive hardware, ESP32s, or LoRa networks. Uses public APIs, satellite feeds, and curated datasets.</p>
          </div>
          <div className="bg-slate-50 p-5 rounded-lg border border-slate-100 space-y-2">
            <h3 className="font-bold text-slate-900 text-base">Predictive Risk Scoring</h3>
            <p className="text-pretty text-slate-600">Combines slope steepness, soil saturation, elevation, and live rainfall into standardized 0–100 risk indexes.</p>
          </div>
          <div className="bg-slate-50 p-5 rounded-lg border border-slate-100 space-y-2">
            <h3 className="font-bold text-slate-900 text-base">Actionable Warnings</h3>
            <p className="text-pretty text-slate-600">Provides authorities with exact affected village names, vulnerable highway corridors, and response steps.</p>
          </div>
        </div>
      </div>
    </div>
