    ...
    <div className="space-y-6 pb-12">
      ...
      <div className="flex items-center justify-between border-b border-slate-800 pb-4">
        <Link
          ...
          className="flex items-center gap-2 text-xs text-slate-400 hover:text-white transition font-mono"
        >
        ...
        <Link
          ...
          className="flex items-center gap-2 px-4 py-2 rounded-lg text-xs font-bold bg-amber-500 hover:bg-amber-400 text-slate-950 shadow transition"
        >
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="space-y-2">
          ...
          <h1 className="text-3xl font-extrabold text-white tracking-tight">{zone.name}</h1>
          <p className="text-sm text-slate-400 font-mono">
            District: <strong className="text-white">{zone.district}</strong> | State: <strong className="text-amber-400">{zone.state}</strong>
          </p>
        </div>

        <div className="bg-slate-950 p-4 rounded-xl border border-slate-800 text-center font-mono space-y-1 min-w-[200px]">
          <span className="text-xs text-slate-400 uppercase">AI Risk Score</span>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 space-y-1">
          ...
          <p className="text-2xl font-extrabold text-white font-mono">{zone.rainfall_mm} mm</p>
          <p className="text-[11px] text-slate-400">Accumulated precipitation</p>
        </div>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 space-y-1">
          ...
          <p className="text-2xl font-extrabold text-white font-mono">{zone.soil_moisture}%</p>
          <p className="text-[11px] text-slate-400">Layer saturation level</p>
        </div>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 space-y-1">
          ...
          <p className="text-2xl font-extrabold text-white font-mono">{zone.slope_deg}°</p>
          <p className="text-[11px] text-slate-400">Escarpment gradient</p>
        </div>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 space-y-1">
          ...
          <p className="text-2xl font-extrabold text-white font-mono">{zone.elevation_m} m</p>
          <p className="text-[11px] text-slate-400">Height above sea level</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-5 space-y-3">
            ...
            <ul className="space-y-2 text-xs">
              {zone.risk_factors.map((factor, idx) => (
                <li key={idx} className="bg-slate-950 p-2.5 rounded border border-slate-800 text-slate-200 flex items-start gap-2">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-5 space-y-4">
            <div>
              <h4 className="font-bold text-white text-xs uppercase flex items-center gap-2 text-blue-400 mb-2">
                <Home className="w-4 h-4" />
                <span>Affected Settlements ({zone.affected_villages.length})</span>
              </h4>
              <div className="flex flex-wrap gap-1.5">
                {zone.affected_villages.map((v, i) => (
                  <span key={i} className="text-xs font-mono bg-slate-950 text-slate-200 px-2.5 py-1 rounded border border-slate-800">
                    {v}
                  </span>
                ))}
              </div>
            ...
            <div>
              <h4 className="font-bold text-white text-xs uppercase flex items-center gap-2 text-purple-400 mb-2">
