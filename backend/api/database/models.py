...
class IngestionRun(TimestampMixin, Base):
    ...
    ingestion_method: Mapped[str | None] = mapped_column(String(50))
    initiated_by: Mapped[str | None] = mapped_column(String(180))
    initiator_role: Mapped[str | None] = mapped_column(String(40))
    authorization_reference: Mapped[str | None] = mapped_column(String(300))
